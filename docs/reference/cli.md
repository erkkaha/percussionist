...
beatctl board task approve <project> --task-name <name>
beatctl board task request-changes <project> --task-name <name> --feedback "..."
beatctl board task retry <project> --task-name <name> [--review]
```
