...
import { normalizeReviewVerdict, DiffFindingSeveritySchema } from "../index.js";
    ...
    const result = normalizeReviewVerdict(
      {
        ...
        findings: [
          ...
          { id: "f3", severity: "not-a-severity", title: "Bad severity", comment: "x", anchors: baseFinding.anchors, context, createdAt: "now" },
          { id: "f4", severity: "low", title: "No comment", anchors: baseFinding.anchors, context, createdAt: "now" },
        ],
      },
      { sourceRunName: "review-1", updatedAt: "2026-06-13T01:00:00.000Z" },
    );
