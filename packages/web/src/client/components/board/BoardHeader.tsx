  ...
  if (isMobile) {
    return (
      <div className="flex items-center justify-between gap-2 shrink-0">
        {/* Minimal board identity */}
        <div className="flex items-center gap-2 min-w-0">
          <span className="text-caption-xs text-text-dim shrink-0">{sseConnected ? '●' : '○'}</span>
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          {codeServerUrl && (
            <Link
              ...
              className="inline-flex items-center justify-center text-text-dim hover:text-text transition-colors p-1.5 rounded-md hover:bg-accent"
