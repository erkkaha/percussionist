    ...
    <div className="space-y-5">
        ...
        {form.retryPolicyEnabled && (
          <>
            <p className="text-xs text-text-dim">
              Retries use exponential backoff — each attempt waits longer than the last. If a retry
              finishes faster than the poison pill threshold, the task is considered stuck and
              retries stop.
            </p>
            <div className="grid grid-cols-3 gap-4 pt-2">
              ...
              <div className="space-y-1.5">
                ...
                />
                <p className="text-xs text-text-dim">
                  Factor applied each retry (e.g. 2 → 30s, 60s, 120s).
                </p>
              </div>
              <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                />
                <p className="text-xs text-text-dim">
                  Retries completing faster than this are treated as stuck.
                </p>
              </div>
            </div>
          </>
      ...
      <fieldset className="space-y-3 rounded-md border border-border p-4">
        ...
        {form.reviewPolicyAiReviewerEnabled && (
          <>
            <p className="text-xs text-text-dim">
              When the reviewer rejects a task, it is sent back for rework automatically. After the
              max rework count is exceeded, it requires manual review.
            </p>
            <div className="grid grid-cols-2 gap-4 pt-2">
              <div className="space-y-1.5">
                ...
                />
                <p className="text-xs text-text-dim">
                  ClusterAgent assigned to review completed tasks.
                </p>
              </div>
              <div className="space-y-1.5">
      ...
      <fieldset className="space-y-3 rounded-md border border-border p-4">
        ...
        <p className="text-xs text-text-dim">Control how git worktrees are managed across runs.</p>
        <Switch checked={form.worktreeReuse} onCheckedChange={(v) => form.setWorktreeReuse(v)} />
        <p className="text-xs text-text-dim">
      ...
      <fieldset className="space-y-3 rounded-md border border-border p-4">
        ...
        <p className="text-xs text-text-dim">
          Control how tasks flow through their lifecycle. Presets provide sensible defaults;
          overrides below customize specific steps.
        </p>
        <div className="space-y-1.5">
          <label className="text-sm font-medium text-text-muted">Preset</label>
          <Select
            value={form.flowPreset}
            onValueChange={(v) => form.setFlowPreset(v as typeof form.flowPreset)}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              ...
              <SelectItem value="plan-build">
                Plan → Build — plan generates builds, human approval
              </SelectItem>
              <SelectItem value="plan-build-review-merge">
                Plan → Build → Review → Merge (default)
              </SelectItem>
            </SelectContent>
          </Select>
        </div>
          ...
          <div className="border-t border-border pt-3 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      form.setFlowHumanApprovalPlan(v as 'required' | 'disabled')
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="space-y-1.5">
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      form.setFlowHumanApprovalBuild(v as 'required' | 'disabled')
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={(v) => form.setFlowPlanOnApprove(v as 'generate-builds' | 'done')}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  form.setFlowBuildOnSuccess(v as 'human-review' | 'ai-review' | 'done')
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={(v) => form.setFlowBuildOnApprove(v as 'merge' | 'done')}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={(v) => form.setFlowMergeMode(v as 'auto' | 'manual' | 'disabled')}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
