  ...
  (
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // Persist the sidebar state across sessions.
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'fixed inset-y-0 z-10 hidden min-h-screen w-64 transition-all duration-200 ease-linear md:flex',
            side === 'left'
            ...
            variant === 'floating' || variant === 'inset'
              ...
              : 'group-data-[collapsible=icon]:w-12 group-data-[side=left]:border-r group-data-[side=right]:border-l border-sidebar-border',
            className,
          )}
          {...props}
        >
